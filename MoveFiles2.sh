...
# Remove old files
sudo rm 7i92t_rosetta.bin
sudo rm 7i92t_rosetta.pin
sudo rm PIN_Rosetta_34.vhd
# Copy new files
...
sudo rm Rosetta.ini
sudo rm custom.hal
sudo rm custom_gvcp.hal
sudo rm custom_postgui.hal
sudo rm shutdown.hal
sudo rm tool.tbl
# Copy new files
...
# Remove old files
sudo rm RosettaLogo-Silver.gif
sudo rm RosettaLogo-Black.gif
# Copy new files
...
cd /home/cnc/linuxcnc/configs
# Remove old files
sudo rm RosettaStartupImage.gif
# Copy new files
