...
# ##################################################
# Step 1e
# This creates the directory for backing up the configuration files
#
echo -e "\e[1;33;1;44m>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<\e[0m"
echo -e "\e[1;33;1;44m>>>>>>>>>>>>>>>>>> Step 1e <<<<<<<<<<<<<<<<<<\e[0m"
# create the backup directory
echo -e "\e[0;33;1;44m Creating required backup directory\e[0m"
cd /home/cnc/linuxcnc
sudo mkdir Backup
cd Backup
sudo mkdir Rosetta
echo -e "\e[0;33;1;44m Copying backup & restore scripts\e[0m"
cd /home/cnc/linuxcnc
sudo cp /home/cnc/Downloads/Backup.sh .
sudo cp /home/cnc/Downloads/Restore.sh .
# ##################################################
# Step 1f
# Notify user to run backup.
#
echo -e "\e[1;33;1;44m>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<\e[0m"
echo -e "\e[1;33;1;44m>>>>>>>>>>>>>>>>>> Step 1f <<<<<<<<<<<<<<<<<<\e[0m"
echo -e "\e[0;33;1;44m Run Backup.sh from /home/cnc/linuxcnc/ \e[0m"
# ##################################################
